...
#define SECRET_SSID         "Buffalo-C130"
#define SECRET_PASS         "nnkxnpshmhai6"
...
#define SECRET_READ_APIKEY  "RYYEE7BOU4SNUSQ1"  // replace XYZ with your channel read API Key(for private channel)
